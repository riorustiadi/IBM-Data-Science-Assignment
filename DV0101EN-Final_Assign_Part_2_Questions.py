...
def update_output_container(selected_statistics, input_year):
    ...
    # Yearly Statistic Report Plots
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, names='Vehicle_Type', values='Advertising_Expenditure', title='Advertisement Expenditure by Vehicle Type in the year {}'.format(input_year)))
